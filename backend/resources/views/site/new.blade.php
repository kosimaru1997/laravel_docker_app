        ...
        <div class="col-12">
            ...
            <form action="{{ route('site_store') }}" method="post">
                ...
                <div class="tag-form w-75 mb-4">
                    ...
                    <input class="form-control" placeholder=",で区切ってください" type="text" name="tag" id="site_tag" value="{{ old('tag') }}">
                </div>
                @error('url')
                ...
                <div id="note-form">
                <textarea class="form-control note-control p-3" id="md-textarea" placeholder="メモ記入欄（マークダウン対応）" name="note" cols="30" rows="13">{{ old('note') }}</textarea>
                </div>
