    ...
    <div class="row mt-3">
        ...
        <div class="col-12">
            ...
            <div class="bg-site py-3 px-4 mb-2">
                <input class="form-control mb-3" placeholder="例：https://hogehoge" type="text" name="site[url]" id="site_url">
                ...
                <div id="note-form">
                <textarea class="form-control note-control p-3" id="md-textarea" placeholder="メモ記入欄（マークダウン対応）" name="site[note]" cols="30" rows="13"></textarea>
                </div>
